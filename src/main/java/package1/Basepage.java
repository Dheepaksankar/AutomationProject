...
public class Basepage {
		...
		if (driver == null) {
			if (browser.equals("chrome")) {
				System.setProperty("webdriver.chrome.driver",
						"G:\\Driver\\Chrome driver\\chromedriver.exe");
			...
			driver.get("https://www.amazon.in/gp/browse.html?node="
					+ "1389401031&ref_=nav_em_sbc_mobcomp_all_mobiles_0_2_8_2");
		}
	}
	...
	public ArrayList<String> arraylist(ArrayList<WebElement> Element){
